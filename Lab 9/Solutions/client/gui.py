...
class ChatGUI:
    ...
    def update_users_list(self, loop: bool):
        ...
        for i in range(len(users)):
            self.users_list.insert(i, f"{'(a)' if users[i].is_active else '(n)'} {users[i].login}")
